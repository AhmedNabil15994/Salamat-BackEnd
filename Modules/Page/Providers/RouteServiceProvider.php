...
class RouteServiceProvider extends ServiceProvider
{
     ...
     protected $clinicModule    = '\Modules\Page\Http\Controllers\Clinic';
    ...
    protected function mapClinicRoutes()
    {
        ...
        ->namespace($this->clinicModule)->group(module_path('Page', 'Routes/clinic/routes.php'));
    ...
    protected function mapApiRoutes()
    {
        Route::group(
            ...
            module_path('Page', 'Routes/api/routes.php')
        );
    }
}
