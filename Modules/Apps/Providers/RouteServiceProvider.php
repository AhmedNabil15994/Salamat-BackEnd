...
class RouteServiceProvider extends ServiceProvider
{
     ...
     protected $clinicModule    = '\Modules\Apps\Http\Controllers\Clinic';
    ...
    protected function mapClinicRoutes()
    {
        ...
        ->namespace($this->clinicModule)->group(module_path('Apps', 'Routes/clinic/routes.php'));
    ...
    protected function mapApiRoutes()
    {
        Route::group(
            ...
            module_path('Apps', 'Routes/api/routes.php')
        );
    }
}
