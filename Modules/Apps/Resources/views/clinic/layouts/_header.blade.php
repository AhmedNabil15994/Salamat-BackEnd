        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                    <a href="{{route("clinic.clinics.edit", ClinicFacade::id())}}">{{__('user::clinic.settings')}}</a>
                </li>
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="{{ route('clinic.users.edit', auth()->id()) }}">
                                <i class="icon-user"></i>{{ __('apps::clinic._layout.navbar.profile') }}
                            </a>
                        </li>
                        <li>
                            <a href="#" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                <i class="icon-key"></i> {{ __('apps::clinic._layout.navbar.logout') }}
                            </a>
