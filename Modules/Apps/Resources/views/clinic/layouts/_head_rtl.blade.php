<head>
	<meta charset="utf-8" />
	<title>@yield('title', '--') || {{ ClinicFacade::title() }}</title>
	...
	<link href="/admin/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap-rtl.css" rel="stylesheet" type="text/css" />
	...
	<link href="/admin/assets/global/css/components-md-rtl.min.css" rel="stylesheet" id="style_components" type="text/css" />
	...
	<link href="/admin/assets/layouts/layout/css/themes/darkblue-rtl.min.css" rel="stylesheet" type="text/css" id="style_color" />
	<link href="/admin/assets/layouts/layout/css/custom-rtl.min.css" rel="stylesheet" type="text/css" />

	<link rel="shortcut icon" href="{{ ClinicFacade::logo() }}" />
