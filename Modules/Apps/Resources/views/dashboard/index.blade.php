        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                    ...
                    <div class="details">
                        ...
                        <div class="desc">{{ __('apps::dashboard.index.statistics.count_users') }}</div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup" data-value="{{$countClinics}}">0</span>
                        </div>
                        <div class="desc">{{ __('apps::dashboard.index.statistics.count_clinics') }}</div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                    ...
                    <div class="details">
                        ...
                        <div class="desc">{{ __('apps::dashboard.index.statistics.total_completed_orders') }}</div>
                    </div>
                </a>
            </div>
        </div>
                        ...
                        <div class="mt-element-card mt-card-round mt-element-overlay">
                            <div class="row">
                                <div class="general-item-list">
                                    ...
                                    <div class="col-md-6">
                                        <b class="page-title">
                                          {{ __('apps::dashboard.index.statistics.orders_status') }}
                                        </b>
