...
class RouteServiceProvider extends ServiceProvider
{
     ...
     protected $clinicModule    = '\Modules\Category\Http\Controllers\Clinic';
    ...
    protected function mapClinicRoutes()
    {
        ...
        ->namespace($this->clinicModule)->group(module_path('Category', 'Routes/clinic/routes.php'));
    ...
    protected function mapApiRoutes()
    {
        Route::group(
            ...
            module_path('Category', 'Routes/api/routes.php')
        );
    }
}
