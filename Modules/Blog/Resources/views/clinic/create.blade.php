...
@section('title', __('blog::clinic.blogs.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('blog::clinic.blogs.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('clinic.blogs.store')}}">
                @csrf
                <div class="col-md-12">
                            ...
                            <div class="tab-pane active fade in" id="general">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="video" class="form-control" data-name="video">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('blog::clinic.blogs.form.type') }}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                          <input type="radio" name="type_" value="clinic" onclick="typeBlog('clinic')"> Clinic
                                          <input type="radio" name="type_" value="doctor" onclick="typeBlog('doctor')"> Doctor
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('blog::clinic.blogs.form.clinic')}}
                                        </label>
                                        <div class="col-md-9">
                                            <select name="clinic_id" id="single" class="form-control select2 clinic_type" data-name="clinic_id" disabled>
                                                <option value=""></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="doctor_id" id="single" class="form-control select2 doctor_type" data-name="doctor_id" disabled>
                                                <option value=""></option>
