        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    @permission('add_blogs')
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.blogs.create')) }}" class="btn sbold green">
                    ...
                    <div class="row">
                        <div class="form-group">
                            @permission('delete_blogs')
                                <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('dashboard.blogs.deletes')) }}')">
