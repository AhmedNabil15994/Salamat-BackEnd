...
<div class="page-content-wrapper">
    <div class="page-content">
            ...
            <ul class="page-breadcrumb">
                ...
                {{-- <li>
                    <a href="{{ url(route('dashboard.users.index')) }}">
                        {{__('user::clinic.doctors.index.title')}}
                    </a>
                    <i class="fa fa-circle"></i>
                </li> --}}
                <li>
                    <a href="#">{{__('user::clinic.profile.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" user="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('clinic.users.update',$user->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
