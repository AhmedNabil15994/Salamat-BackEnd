...
@section('title', __('room::dashboard.rooms.update.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url(route('dashboard.rooms.index')) }}">
                        {{__('room::dashboard.rooms.index.title')}}
                    </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <a href="#">{{__('room::dashboard.rooms.update.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" room="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.rooms.update',$room->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li class="active">
                                                <a href="#global_setting" data-toggle="tab">
                                                    {{ __('room::dashboard.rooms.update.form.general') }}
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="#availability" data-toggle="tab">
                                                    {{ __('room::dashboard.rooms.create.form.availability') }}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <h3 class="page-title">{{__('room::dashboard.rooms.update.form.general')}}</h3>
                                <div class="col-md-10">

                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('room::dashboard.rooms.update.form.name')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" name="name" class="form-control" data-name="name" value="{{ $room->name }}">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('room::dashboard.rooms.create.form.clinics')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                            <select name="clinic_id" id="single" class="form-control select2" data-name="clinic_id">
                                                ...
                                                <option value="{{ $clinic['id'] }}" {{ ($room->clinic->clinic_id == $clinic->id) ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('room::dashboard.rooms.update.form.roles')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                            <div class="mt-checkbox-list">
                                                ...
                                                <label class="mt-checkbox">
                                                    <input type="checkbox" name="roles[]" value="{{$role->id}}" {{ $room->roles->contains($role->id) ? 'checked=""' : ''}}>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('room::dashboard.rooms.update.form.image')}}
                                        </label>
                                        <div class="col-md-9">
                                            ...
                                            <span class="holder" style="margin-top:15px;max-height:100px;">
                                                <img src="{{$room->image ? url($room->image) : ''}}" style="height: 15rem;">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" id="test" data-size="small" name="status" {{($room->status == 1) ? ' checked="" ' : ''}}>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="colored-rounded-tab-general-opening">
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('room::dashboard.rooms.form.open_time')}}
                                                    <span class="required" aria-required="true">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control 24_format" name="open_time" data-name="open_time" value="{{$room->shift->start_time}}">
                                                        <span class="input-group-btn">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('room::dashboard.rooms.form.close_time')}}
                                                    <span class="required" aria-required="true">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control 24_format" name="close_time" data-name="close_time" value="{{$room->shift->end_time}}">
                                                        <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-clock-o"></i>
                                                            </button>
                                        ...
                                        <div class="tab-pane fade in" id="colored-rounded-tab-general-days">
                                            ...
                                            @php
                                                $offDay = $room->offDays->first(function($val) use($day) {
                                        ...
                                        <div class="tab-pane fade in" id="colored-rounded-tab-general-times">
                                            <div class="break-form">
                                                <div class="break-form-content-added">
                                                    @foreach ($room->offTimes as $offTime)
                                                    <div class="form-group">
                                        ...
                                        <div class="tab-pane fade in" id="colored-rounded-tab-general-dates">
                                            <div class="dates-form">
                                                <div class="dates-form-content-added">
                                                    @foreach ($room->offDates as $offDate)
                                                    <div class="form-group">
                                        ...
                                        <div class="tab-pane fade in" id="colored-rounded-tab-general-custom-off">
                                            ...
                                            <div class="custom-off-form">
                                                <div class="custom-off-form-content-added">
                                                    @foreach ($room->offCustomDates as $offCustomDate)
                                                    <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-actions">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{url(route('dashboard.rooms.index')) }}" class="btn btn-lg red">
