...
namespace Modules\Room\Repositories\Dashboard;
...
class RoomRepository
{
    ...
    */
    ...
    {
        $room = $this->room->withDeleted()->find($id);
        return $room;
    }
    ...
    */
    ...
    {
        $room = $this->room->where('email',$email)->first();
        return $room;
    }
    ...
    */
    ...
    {
        $query = $this->room->where('id','!=',auth()->id())->whereHas('roles.perms', function($query){
