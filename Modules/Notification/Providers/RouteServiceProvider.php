...
class RouteServiceProvider extends ServiceProvider
{
     ...
     protected $clinicModule    = '\Modules\Notification\Http\Controllers\Clinic';
    ...
    protected function mapDashboardRoutes()
    {
        ...
        ->namespace($this->dashboardModule)->group(module_path('Notification', 'Routes/dashboard/routes.php'));
    ...
    protected function mapClinicRoutes()
    {
        ...
        ->namespace($this->clinicModule)->group(module_path('Notification', 'Routes/clinic/routes.php'));
    ...
    protected function mapWebRoutes()
    {
        ...
        ->namespace($this->frontendModule)->group(module_path('Notification', 'Routes/frontend/routes.php'));
    }
    ...
    protected function mapApiRoutes()
    {
        Route::group(
            ...
            module_path('Notification', 'Routes/api/routes.php')
        );
    }
}
