...
@section('title', __('offer::clinic.booked_offers.show.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url(route('clinic.booked_offers.index')) }}">
                        {{__('offer::clinic.booked_offers.index.title')}}
                    </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <a href="#">{{__('offer::clinic.booked_offers.show.title')}}</a>
                </li>
            </ul>
        </div>
                        ...
                        <ul class="ver-inline-menu tabbable margin-bottom-10">
                            <li class="active">
                                <a data-toggle="tab" href="#offer">
                                    <i class="fa fa-cog"></i> {{__('offer::clinic.booked_offers.show.invoice')}}
                                </a>
                                <span class="after"></span>
                            </li>
                            <li class="">
                                <a data-toggle="tab" href="#transactions">
                                    <i class="fa fa-cog"></i> {{__('transaction::clinic.booked_offers.show.transactions')}}
                                </a>
                                <span class="after"></span>
                            </li>
                        </ul>
                    ...
                    <div class="tab-content">
                                ...
                                <div class="row invoice-head">
                                    ...
                                    <div class="col-md-6 col-xs-6">
                                        <div class="company-address">
                                            ...
                                            <span class="bold">
                                                {{__('offer::clinic.booked_offers.show.from')}} :
                                            </span>
                                            {{ $offer->user->name}}
                                            <br />
                                            <span class="bold">
                                                {{__('offer::clinic.booked_offers.show.mobile')}} :
                                            </span>
                                            {{ $offer->user->mobile }}
                                            <br />
                                        </div>
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th class="invoice-title uppercase text-center">
                                                            {{__('offer::clinic.booked_offers.show.total')}}
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                        ...
                        <div class="tab-pane" id="transactions">
                            <div class="invoice">
                                ...
                                <div class="row">
                                    <h3>{{__('transaction::clinic.booked_offers.show.transactions')}}</h3>
                                    <div class="col-xs-12 table-responsive">
                                        <table class="table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('transaction::clinic.booked_offers.show.transaction.payment_id')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('transaction::clinic.booked_offers.show.transaction.track_id')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('transaction::clinic.booked_offers.show.transaction.method')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('transaction::clinic.booked_offers.show.transaction.result')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('transaction::clinic.booked_offers.show.transaction.ref')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('transaction::clinic.booked_offers.show.transaction.tran_id')}}
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
