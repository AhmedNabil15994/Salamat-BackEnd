...
class RouteServiceProvider extends ServiceProvider
{
     ...
     protected $clinicModule    = '\Modules\Setting\Http\Controllers\Clinic';
    ...
    protected function mapClinicRoutes()
    {
        ...
        ->namespace($this->clinicModule)->group(module_path('Setting', 'Routes/clinic/routes.php'));
    ...
    protected function mapApiRoutes()
    {
        Route::group(
            ...
            module_path('Setting', 'Routes/api/routes.php')
        );
    }
}
