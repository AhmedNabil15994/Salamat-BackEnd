...
class RouteServiceProvider extends ServiceProvider
{
     ...
     protected $clinicModule    = '\Modules\Order\Http\Controllers\Clinic';
    ...
    protected function mapDashboardRoutes()
    {
        ...
        ->namespace($this->dashboardModule)->group(module_path('Order', 'Routes/dashboard/routes.php'));
    ...
    protected function mapClinicRoutes()
    {
        ...
        ->namespace($this->clinicModule)->group(module_path('Order', 'Routes/clinic/routes.php'));
    ...
    protected function mapWebRoutes()
    {
        ...
        ->namespace($this->frontendModule)->group(module_path('Order', 'Routes/frontend/routes.php'));
    }
    ...
    protected function mapApiRoutes()
    {
        Route::group(
            ...
            module_path('Order', 'Routes/api/routes.php')
        );
    }
}
