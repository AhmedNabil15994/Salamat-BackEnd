                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('order::dashboard.orders.datatable.operator')}}</th>
                                    <th>{{__('order::dashboard.orders.datatable.doctor')}}</th>
                                    <th>{{__('order::dashboard.orders.datatable.service')}}</th>
                                    <th>{{__('order::dashboard.orders.datatable.user')}}</th>
                                    <th>{{__('order::dashboard.orders.datatable.date')}}</th>
                                    <th>{{__('order::dashboard.orders.datatable.time_from')}}</th>
                                    <th>{{__('order::dashboard.orders.datatable.time_to')}}</th>
        ...
        var dataTable =
            $('#dataTable').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'operator',className: 'dt-center' ,orderable: false
                    },
                    {
