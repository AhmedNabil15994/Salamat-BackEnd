                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.order-statuses.create')) }}" class="btn sbold green">
                    ...
                    <div class="row">
                        <div class="form-group">
                            @permission('delete_order-statuses')
                                <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('dashboard.order-statuses.deletes')) }}')">
