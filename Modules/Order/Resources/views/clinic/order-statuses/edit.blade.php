...
@section('title', __('order::clinic.order_statuses.routes.update'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url(route('clinic.order-statuses.index')) }}">
                        {{__('order::clinic.order_statuses.routes.index')}}
                    </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <a href="#">{{__('order::clinic.order_statuses.routes.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('clinic.order-statuses.update',$orderStatus->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li class="active">
                                                <a href="#global_setting" data-toggle="tab">
                                                    {{ __('order::clinic.order_statuses.form.tabs.general') }}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <h3 class="page-title">{{__('order::clinic.order_statuses.form.tabs.general')}}</h3>
                                <div class="col-md-10">

                                    @foreach (config('translatable.locales') as $code)
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('order::clinic.order_statuses.form.title')}} - {{ $code }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group form-md-radios">
                                        <label class="col-md-2">
                                            {{__('order::clinic.order_statuses.form.color_label')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('order::clinic.order_statuses.form.success_status')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('order::clinic.order_statuses.form.failed_status')}}
                                        </label>
                                        <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="form-actions">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{url(route('clinic.order-statuses.index')) }}" class="btn btn-lg red">
