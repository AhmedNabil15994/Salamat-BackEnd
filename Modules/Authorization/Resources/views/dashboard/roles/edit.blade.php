...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <form id="updateForm" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.roles.update',$role->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                    <div class="col-md-3">
                            ...
                            <div class="tab-pane active fade in" id="general">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="name" placeholder="add_user" class="form-control" data-name="name" value="{{ $role->name }}">
                                                ...
                                                <ul>
                                                    ...
                                                    <li style="list-style-type:none">
                                                        ...
                                                        <ul style="list-style-type:none">
                                                            ...
                                                            <li style="list-style-type:none">
                                                                <label class="mt-checkbox">
                                                                    <input class="child" type="checkbox" name="permission[]" value="{{$permission->id}}" {{ $role->perms->contains($permission->id) ? 'checked=""' : ''}}>
                                                                    {{$permission->translate(locale())->description}}
                                                                    <span></span>
                                                                </label>
                                                            </li>
                                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="display_name[{{$code}}]" placeholder="users" class="form-control" data-name="display_name" value="{{ $role->translate($code)->display_name }}">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('authorization::dashboard.roles.form.description')}} - {{ $code }}
                                        </label>
                                        <div class="col-md-9">
                                            <textarea name="description[{{$code}}]" rows="8" cols="80" class="form-control" data-name="description.{{$code}}">{{ $role->translate($code)->description }}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
