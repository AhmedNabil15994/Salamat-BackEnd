...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.roles.store')}}">
                @csrf
                <div class="col-md-12">
                    <div class="col-md-3">
                            ...
                            <div class="tab-pane active fade in" id="general">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="display_name[{{$code}}]" placeholder="users" class="form-control" data-name="display_name.{{$code}}">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
