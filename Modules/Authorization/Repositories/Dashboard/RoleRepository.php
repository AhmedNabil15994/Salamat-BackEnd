...
class RoleRepository
{
    ...
    public function getAllRoomsRoles($order = 'id', $sort = 'desc')
    {
    ...
    public function getAllStaffsRoles($order = 'id', $sort = 'desc')
    {
        $roles = $this->role->whereHas('perms', function($query){
    ...
    public function getAllOperatorsRoles($order = 'id', $sort = 'desc')
    {
        $roles = $this->role->whereHas('perms', function($query){
    ...
    public function getAllDoctorsRoles($order = 'id', $sort = 'desc')
    {
        $roles = $this->role->whereHas('perms', function($query){
