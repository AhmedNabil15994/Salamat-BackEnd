...
class RouteServiceProvider extends ServiceProvider
{
     ...
     protected $clinicModule    = '\Modules\Area\Http\Controllers\Clinic';
    ...
    protected function mapClinicRoutes()
    {
        ...
        ->namespace($this->clinicModule)->group(module_path('Area', 'Routes/clinic/routes.php'));
    ...
    protected function mapApiRoutes()
    {
        Route::group(
            ...
            module_path('Area', 'Routes/api/routes.php')
        );
    }
}
