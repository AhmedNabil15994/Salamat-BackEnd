...
@section('title', __('clinic::clinic.clinics.routes.create'))
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url(route('clinic.clinics.index')) }}">
                        {{__('clinic::clinic.clinics.routes.index')}}
                    </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <a href="#">{{__('clinic::clinic.clinics.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('clinic.clinics.store')}}">
                @csrf
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-actions">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{url(route('clinic.clinics.index')) }}" class="btn btn-lg red">
