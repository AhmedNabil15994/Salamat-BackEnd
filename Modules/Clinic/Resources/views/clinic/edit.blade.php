...
@section('title', __('clinic::clinic.clinics.routes.update'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('clinic::clinic.clinics.routes.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('clinic.clinics.update',$clinic->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li class="active">
                                                <a href="#global_setting" data-toggle="tab">
                                                    {{ __('clinic::clinic.clinics.form.tabs.general') }}
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="#address" data-toggle="tab">
                                                    {{ __('clinic::clinic.clinics.form.address') }}
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="#social_media" data-toggle="tab">
                                                    {{ __('clinic::clinic.clinics.form.social_media') }}
                                                </a>
                                            </li>
                                            {{-- <li class="">
                                                <a href="#gallery" data-toggle="tab">
                                                    {{ __('clinic::clinic.clinics.form.gallery') }}
                                                </a>
                                            </li> --}}
                                            <li class="">
                                                <a href="#contacts" data-toggle="tab">
                                                    {{ __('clinic::clinic.clinics.form.contacts') }}
                                                </a>
                                            </li>
                                            <li class="">
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <h3 class="page-title">{{__('clinic::clinic.clinics.form.tabs.general')}}</h3>
                                <div class="col-md-10">

                                    @foreach (config('translatable.locales') as $code)
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('clinic::clinic.clinics.form.title')}} - {{ $code }}
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('clinic::clinic.clinics.form.description')}} - {{ $code }}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('clinic::clinic.clinics.form.image')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('clinic::clinic.clinics.form.is_busy')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('clinic::clinic.clinics.form.status')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('clinic::clinic.clinics.form.restore')}}
                                        </label>
                                        <div class="col-md-9">
                            ...
                            <div class="tab-pane fade in" id="address">
                                <h3 class="page-title">{{__('clinic::clinic.clinics.form.address')}}</h3>
                                <div class="col-md-10">

                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.state') }}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.block') }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.street') }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.building') }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.phone_number') }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.another_phone_number') }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.address_details') }}
                                        </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-10">
                                    <div class="contact-form">
                                        ...
                                        <div class="form-contacts">
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('clinic::clinic.clinics.form.contact_number')}}
                                                </label>
                            ...
                            <div class="tab-pane fade in" id="social_media">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.facebook') }}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="social[facebook]" value="{!! $clinic->clinicSocialMediaByName('facebook')['link'] !!}" placeholder="https://facebook.com/account"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.twitter') }}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="social[twitter]" value="{!! $clinic->clinicSocialMediaByName('twitter')['link'] !!}" placeholder="https://twitter.com/account" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.instagram') }}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="social[instagram]" value="{!! $clinic->clinicSocialMediaByName('instagram')['link'] !!}" placeholder="https://instagram.com/account"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.linkedin') }}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="social[linkedin]" value="{!! $clinic->clinicSocialMediaByName('linkedin')['link'] !!}" placeholder="https://linkedin.com/account"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('clinic::clinic.clinics.form.youtube') }}
                                        </label>
                                        <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="form-actions">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{url(route('clinic.home')) }}" class="btn btn-lg red">
