...
namespace Modules\Clinic\Repositories\Clinic;
...
class ClinicRepository
{
    ...
    {
        $clinics = $this->clinic->where('id',ClinicFacade::id())->active()->orderBy($order, $sort)->get();
        return $clinics;
    }

    public function getAll($order = 'id', $sort = 'desc')
    {
        $clinics = $this->clinic->where('id',ClinicFacade::id())->orderBy($order, $sort)->get();
        return $clinics;
    }

    public function findById($id)
    {
        $clinic = $this->clinic->where('id',ClinicFacade::id())->withDeleted()->find($id);
        return $clinic;
    }
    ...
    {
        $query = $this->clinic->where('id',ClinicFacade::id())->where(function($query) use($request){
