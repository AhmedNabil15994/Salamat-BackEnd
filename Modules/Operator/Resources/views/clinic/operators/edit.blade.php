...
@section('title', __('operator::clinic.operators.update.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url(route('clinic.operators.index')) }}">
                        {{__('operator::clinic.operators.index.title')}}
                    </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <a href="#">{{__('operator::clinic.operators.update.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" operator="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('clinic.operators.update',$operator->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li class="active">
                                                <a href="#global_setting" data-toggle="tab">
                                                    {{ __('operator::clinic.operators.update.form.general') }}
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="#availability" data-toggle="tab">
                                                    {{ __('operator::clinic.operators.create.form.availability') }}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <h3 class="page-title">{{__('operator::clinic.operators.update.form.general')}}</h3>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('operator::clinic.operators.update.form.name')}}
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('operator::clinic.operators.update.form.email')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('operator::clinic.operators.update.form.mobile')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('operator::clinic.operators.update.form.password')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('operator::clinic.operators.update.form.confirm_password')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('operator::clinic.operators.update.form.roles')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('operator::clinic.operators.update.form.image')}}
                                        </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="colored-rounded-tab-general-opening">
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('operator::clinic.operators.form.open_time')}}
                                                    <span class="required" aria-required="true">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('operator::clinic.operators.form.close_time')}}
                                                    <span class="required" aria-required="true">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-actions">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{url(route('clinic.operators.index')) }}" class="btn btn-lg red">
