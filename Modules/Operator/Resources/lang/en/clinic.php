...
return [
    'operators' => [
        ...
        'validation'=> [
            'email'     => [
                'required'  => 'Please enter the email of operator',
            ...
            'mobile'    => [
                ...
                'required'          => 'Please enter the mobile of operator',
                'unique'            => 'This mobile is taken before',
            ],
            'name'      => [
                'required'  => 'Please enter the name of operator',
            ],
            'password'  => [
                'min'       => 'Password must be more than 6 characters',
                'required'  => 'Please enter the password of operaor',
                'same'      => 'The Password confirmation not matching',
            ],
            'roles'     => [
                'required'  => 'Please select the role of operator',
            ],
        ],
    ],
];
