...
namespace Modules\Operator\Repositories\Dashboard;
...
class OperatorRepository
{
    ...
    */
    ...
    {
        $operator = $this->operator->withDeleted()->find($id);
        return $operator;
    }
    ...
    */
    ...
    {
        $operator = $this->operator->where('email',$email)->first();
        return $operator;
    }
    ...
    */
    ...
    {
        $query = $this->operator->where('id','!=',auth()->id())->whereHas('roles.perms', function($query){
