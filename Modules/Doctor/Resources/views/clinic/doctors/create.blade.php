...
@section('title', __('doctor::clinic.doctors.create.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('doctor::clinic.doctors.create.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('clinic.doctors.store')}}">
                @csrf
                <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li class="active">
                                                <a href="#global_setting" data-toggle="tab">
                                                    {{ __('doctor::clinic.doctors.create.form.general') }}
                                                </a>
                                            </li>
                                            ...
                                            <li class="">
                                                <a href="#social_media" data-toggle="tab">
                                                    {{ __('doctor::clinic.doctors.create.form.social_media') }}
                                                </a>
                                            </li>
                                            {{-- <li class="">
                                                <a href="#gallery" data-toggle="tab">
                                                    {{ __('doctor::clinic.doctors.create.form.gallery') }}
                                                </a>
                                            </li> --}}
                                            <li class="">
                                                <a href="#contacts" data-toggle="tab">
                                                    {{ __('doctor::clinic.doctors.create.form.contacts') }}
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="#specialty" data-toggle="tab">
                                                    {{ __('doctor::clinic.doctors.create.form.specialty') }}
                                                </a>
                                            </li>
                                            <li class="">
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <h3 class="page-title">{{__('doctor::clinic.doctors.create.form.general')}}</h3>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::clinic.doctors.create.form.name')}}
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::clinic.doctors.create.form.email')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::clinic.doctors.create.form.mobile')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::clinic.doctors.create.form.password')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::clinic.doctors.create.form.confirm_password')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::clinic.doctors.create.form.image')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::clinic.doctors.create.form.roles')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                            ...
                            <div class="tab-pane fade in" id="contacts">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="get-contact-form" style="display:none">
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('doctor::clinic.doctors.create.form.contact_number')}}
                                            </label>
                                            <div class="input-group col-md-9">
                            ...
                            <div class="tab-pane fade in" id="social_media">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::clinic.doctors.create.form.facebook') }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::clinic.doctors.create.form.twitter') }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::clinic.doctors.create.form.instagram') }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::clinic.doctors.create.form.linkedin') }}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::clinic.doctors.create.form.youtube') }}
                                        </label>
                                        <div class="col-md-9">
