...
@section('title', __('doctor::dashboard.doctors.update.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('doctor::dashboard.doctors.update.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" doctor="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.doctors.update',$doctor->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li class="active">
                                                <a href="#global_setting" data-toggle="tab">
                                                    {{ __('doctor::dashboard.doctors.update.form.general') }}
                                                </a>
                                            </li>
                                            ...
                                            <li class="">
                                                <a href="#social_media" data-toggle="tab">
                                                    {{ __('doctor::dashboard.doctors.update.form.social_media') }}
                                                </a>
                                            </li>
                                            {{-- <li class="">
                                                <a href="#gallery" data-toggle="tab">
                                                    {{ __('doctor::dashboard.doctors.update.form.gallery') }}
                                                </a>
                                            </li> --}}
                                            <li class="">
                                                <a href="#contacts" data-toggle="tab">
                                                    {{ __('doctor::dashboard.doctors.update.form.contacts') }}
                                                </a>
                                            </li>
                                            {{-- <li class="">
                                                <a href="#rates" data-toggle="tab">
                                                    {{ __('doctor::dashboard.doctors.update.form.rates') }}
                                                </a>
                                            </li> --}}
                                            <li class="">
                                                <a href="#specialty" data-toggle="tab">
                                                    {{ __('doctor::dashboard.doctors.update.form.specialty') }}
                                                </a>
                                            </li>
                                            <li class="">
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <h3 class="page-title">{{__('doctor::dashboard.doctors.update.form.general')}}</h3>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::dashboard.doctors.update.form.name')}}
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::dashboard.doctors.update.form.email')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::dashboard.doctors.update.form.mobile')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::dashboard.doctors.update.form.password')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::dashboard.doctors.update.form.confirm_password')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="clinic_id" id="single" class="form-control select2" data-name="clinic_id">
                                                ...
                                                <option value="{{ $clinic['id'] }}" {{ ($doctor->clinic->clinic_id == $clinic->id) ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::dashboard.doctors.update.form.roles')}}
                                            <span class="required" aria-required="true">*</span>
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('doctor::dashboard.doctors.update.form.image')}}
                                        </label>
                                        <div class="col-md-9">
                            ...
                            <div class="tab-pane fade in" id="profile">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea dir="{{ $code === 'ar' ? 'rtl' : 'ltr' }}" name="open_time_message[{{$code}}]" rows="8" cols="80" class="form-control" data-name="open_time_message.{{$code}}">{{ $doctor->profile ? $doctor->profile->translate($code)->open_time_message : '' }}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
                                ...
                                <div class="col-md-10">
                                    <div class="contact-form">
                                        ...
                                        <div class="form-contacts">
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('doctor::dashboard.doctors.update.form.contact_number')}}
                                                </label>
                            ...
                            {{-- <div class="tab-pane fade in" id="rates">
                                <h3 class="page-title">
                                    {{__('doctor::dashboard.doctors.update.form.rates')}}
                                </h3>
                                <div class="col-md-10">
                                    <div class="rate-form">
                                        ...
                                        <div class="form-rate">
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('doctor::dashboard.doctors.update.form.rate')}}
                                                </label>
                                                <div class="input-group col-md-9">
                                                    <input name="rate_[old][{{ $rate['id'] }}]" class="form-control" type="text" value="{{ $rate['rate'] }}">
                                                    <span class="input-group-btn">
                                                        <a data-input="images" data-preview="holder" class="btn btn-danger delete-rate">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="get-rate-form" style="display:none">
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('doctor::dashboard.doctors.update.form.rate_number')}}
                                            </label>
                                            <div class="input-group col-md-9">
                                                <input name="rate_[new][]" class="form-control" type="text">
                                                <span class="input-group-btn">
                                                    <a data-input="images" data-preview="holder" class="btn btn-danger delete-rate">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                    ...
                                    <div class="form-group">
                                        <button type="button" class="btn green btn-lg mt-ladda-btn ladda-button btn-circle btn-outline add-rate" data-style="slide-down" data-spinner-color="#333">
                                            <span class="ladda-label">
                                                <i class="icon-plus"></i>
                                            </span>
                                        </button>
                            ...
                            <div class="tab-pane fade in" id="social_media">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::dashboard.doctors.update.form.facebook') }}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="social[facebook]" value="{!! $doctor->doctorSocialMediaByName('facebook')['link'] !!}" placeholder="https://facebook.com/account" data-name="social.facebook">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::dashboard.doctors.update.form.twitter') }}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="social[twitter]" value="{!! $doctor->doctorSocialMediaByName('twitter')['link'] !!}" placeholder="https://twitter.com/account" data-name="social.twitter">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::dashboard.doctors.update.form.instagram') }}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="social[instagram]" value="{!! $doctor->doctorSocialMediaByName('instagram')['link'] !!}" placeholder="https://instagram.com/account" data-name="social.instagram">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::dashboard.doctors.update.form.linkedin') }}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="social[linkedin]" value="{!! $doctor->doctorSocialMediaByName('linkedin')['link'] !!}" placeholder="https://linkedin.com/account" data-name="social.linkedin">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{ __('doctor::dashboard.doctors.update.form.youtube') }}
                                        </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-10">
                                        ...
                                        <ul class="nav nav-tabs bg-slate nav-tabs-component">
                                            ...
                                            <li class="">
                                                <a href="#colored-rounded-tab-general-days" data-toggle="tab" aria-expanded="false">
                                                    {{__('doctor::dashboard.doctors.form.days')}}
                                                </a>
                                            </li>
                                            <li class="">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="colored-rounded-tab-general-opening">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('doctor::dashboard.doctors.form.close_time')}}
                                                    <span class="required" aria-required="true">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
...
<script>
    // CONTACT FORM / ADD NEW BUTTON UPLOAD
    $(document).ready(function() {
        var html = $("div.get-rate-form").html();
        $(".add-rate").click(function(e) {
            e.preventDefault();
            $(".rate-form").append(html);
            $('.lfm').filemanager('image');
        });
    });

    // DELETE UPLOAD BUTTON
    $(".rate-form").on("click", ".delete-rate", function(e) {
        e.preventDefault();
        $(this).closest('.form-group').remove();
    });
</script>
