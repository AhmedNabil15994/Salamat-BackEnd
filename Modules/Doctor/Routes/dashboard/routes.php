...
Route::group(['prefix' => 'doctors'], function () {
    ...
    Route::get('sorting' ,'DoctorController@sorting')
    ->name('dashboard.doctors.sorting')
    ->middleware(['permission:show_doctors']);

    Route::get('store/sorting' ,'DoctorController@storeSorting')
    ->name('dashboard.doctors.store.sorting')
    ->middleware(['permission:show_doctors']);
