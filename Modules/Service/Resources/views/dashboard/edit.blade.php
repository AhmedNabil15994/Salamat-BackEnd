...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.services.update',$service->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="point_amount" class="form-control" data-name="point_amount" value="{{ $service->points ? $service->points->amount : '' }}" placeholder="0.000">
                                            <b>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="points_per_amount" class="form-control" data-name="points_per_amount" value="{{ $service->points ? $service->points->points_per_amount : '' }}" placeholder="0">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
